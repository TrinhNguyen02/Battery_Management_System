...
/**
  * @brief  Function implementing the readADC_Task thread.
...
/**
* @brief Function implementing the ctrlBMS_Task thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the comUART_Task thread.
* @param argument: Not used
* @retval None
*/
